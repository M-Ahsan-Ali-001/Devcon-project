...
class JudgeSignUpForm1 extends StatefulWidget {
  const JudgeSignUpForm1({super.key});

  @override
  State<JudgeSignUpForm1> createState() => _JudgeSignUpForm1State();
}
...
class _JudgeSignUpForm1State extends State<JudgeSignUpForm1> {
  @override
